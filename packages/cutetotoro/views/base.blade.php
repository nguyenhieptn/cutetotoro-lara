			...
			<div class="">
				...
				<div class="offcanvas offcanvas-start" data-bs-scroll="true" data-bs-backdrop="false" tabindex="-1" id="offcanvasScrolling" aria-labelledby="offcanvasScrollingLabel">
	  				<div class="offcanvas-header">
	    				<h5 class="offcanvas-title" id="offcanvasScrollingLabel">Totoro Shop</h5>
	    				<button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
	  				</div>
				 	<div class="offcanvas-body">
				    	<p>Slide Bar nó nằm ở đây nè</p>
				  	</div>
				</div>
			</div>
			<div class="d-flex">
				<a class="link" href="/mug"><p class="Mug__CSS">Mug</p></a>
				<a class="link" href="/t-shirt"><p class="T__Shirt">T-shirt</p></a>
				<a class="link" href="/sticker"><p class="T__Shirt">Sticker</p></a>
				<a class="link" href="/poster"><p class="T__Shirt">Poster</p></a>
				<a class="link" href="/bag"><p class="T__Shirt">Bag</p></a>
				<a class="link" href="/orther"><p class="T__Shirt">Other</p></a>
			</div>
			<div class="">
				<a href="/home-page">
			...
			<div id="carouselExample" class="carousel slide">
				<div class="carousel-inner">
					<div class="carousel-item active">
						<img class="banner_img" src="{{asset('FrontEnd/Image/banner1.png')}}" class="d-block w-100" alt="i love you">
					</div>
					<div class="carousel-item">
						<img class="banner_img" src="{{asset('FrontEnd/Image/sale.png')}}" class="d-block w-100" alt="...">
					</div>
					<div class="carousel-item">
						<img class="banner_img" src="{{asset('FrontEnd/Image/bestchoose.png')}}" class="d-block w-100" alt="...">
					</div>
					<div class="carousel-item">
						<img class="banner_img" src="{{asset('FrontEnd/Image/saleup.png')}}" class="d-block w-100" alt="...">
					</div>
				</div>
