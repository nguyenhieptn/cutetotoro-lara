...
@section('content')
    ...
    <div class="container">
        ...
        <div class="element" style="margin-top: 81px;">
            @foreach ($search_product as $key => $dt)
                <div class="element-item">
                    <div class="mug-product">
                        <a href="{{ route('product.detail',$dt->parentid ) }}" style="display: block">
                            <div class="mug-img">
                                <img src="/aimeos/{{ $dt->link }}" class="girl img-responsive" alt=""/>
                            ...
                            <div class="best_seller_bottom">
                                ...
                                <div class="best_seller-price">
                                    <p style="display: flex; align-item: center; margin-right: 15px">
                                        <strike>{{ $dt->value }}$</strike>
                                    </p>
                                    <p>{{ $dt->value - $dt->rebate }}$</p>
                                </div>
                            </div>
