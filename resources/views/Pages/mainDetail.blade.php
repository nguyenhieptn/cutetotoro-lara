            ...
            <div class="col col-12 col-xl-4 pt-3">
                <div class="main-details-content-wrap">
                    <ul class="main-details-content mb-0">
                        ...
                        <li style="margin-top: 30px">
                            <button
                                style="font-family: 'Manjari'; font-style: normal; font-weight: 700; font-size: 16px; color: #ffff; background: grey"
                                type="button" class="btn " data-bs-toggle="modal" data-bs-target="#exampleModal">
                                Add to cart
                            </button>
                            <div style="with: 100%" class="modal fade" id="exampleModal" tabindex="-1"
                                 aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                                     style="max-width: none; padding-left: 14px;">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            ">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img
                                                            src="https://drive.google.com/uc?export=view&id=1Ii4kOkwDhzWr8Fhz2CSwCw43Yzs_GfPV"
                                                            alt="">
                                                    </td>
                                                    <td>
                                                        <input class="value" type="number" required="required"
                                                               name="b_prod[0][quantity]" value="6" step="1" min="1"
                                                               max="2147483647">
                                                    </td>
                                                    <td>
                                            ...
                                            <div class="subtotal row g-0"
                                                 style="font-family: 'Manjari'; font-style: normal; font-weight: 700; font-size: 16px; color: #000000;">
                                            ...
                                            <div class="basket-standard-coupon"
                                                 style="font-family: 'Manjari'; font-style: normal; font-weight: 700; font-size: 16px; color: #000000;">
                                                <div class="header">
                                                    <h2 style="font-family: 'Manjari'; font-style: normal; font-weight: 700; font-size: 16px; color: #000000;">
                                                        Coupon codes</h2>
                                                </div>
                                                <div class="content">
                                                    <div class="input-group coupon-new"
                                                        ...
                                                        <input
                                                            style="font-family: 'Manjari'; font-style: normal; font-weight: 700; font-size: 16px; color: #000000;"
                                                            class="form-control coupon-code" type="text" maxlength="255"
                                        ...
                                        <div class="modal-footer" style="justify-content: center">
                                            ...
                                            <button
                                                style="font-family: 'Manjari'; font-style: normal; font-weight: 700; font-size: 16px; color: #ffffff;"
